...
os.chdir("C:\\Users\\Francesco\\Desktop\\CalibrazioniMigliori")
...
for graph in os.listdir():
	...
	plt.subplot(221)
	plt.axis('off')
	plt.text(0.03, 0.27, "Durata: %d\nVolume: %d\n\nMedia ritardo: %f\nDev. st. ritardo: %f" \
		%(metadata[1], metadata[0], delaysMean, delaysStDev))
	plt.subplot(222)
	...
	for index, epoch in enumerate(epochs):
		if index not in trialsToReject:
